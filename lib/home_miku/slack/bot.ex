defmodule HomeMiku.Slack.Bot do
  ...
  def react_to_message(%{type: "message", subtype: "message_changed"}, _), do: {:skip}
  def react_to_message(%{type: "message", subtype: "message_deleted"}, _), do: {:skip}
  def react_to_message(%{type: "message", subtype: "channel_join"}, _), do: {:skip}
